...
def poll():
    ...
    obj1 = bpy.data.objects["Armature"].pose.bones["arm right shoulder 2"]
    obj2 = bpy.data.objects["Armature"].pose.bones["arm right elbow"]
    ...
    obj1.rotation_quaternion[2] = jData["q1"][0];
    obj1.rotation_quaternion[1] = -jData["q1"][1];
    obj1.rotation_quaternion[3] = jData["q1"][2];
    obj1.rotation_quaternion[0] = jData["q1"][3];
    obj2.rotation_quaternion[2] = jData["q2"][0];
    obj2.rotation_quaternion[1] = -jData["q2"][1];
